...
//@interface educoreObject : NSObject
//@end

@interface educoreObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[educoreObject class]])
		{
			for (NSString *key in [[(educoreObject*)o modules] allKeys])
			{
