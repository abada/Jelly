...
// in simulator we redefine to format for educore Developer console
...
{\
	NSString * exceptionName = [@"org.educore." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.educore";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIeducoreNativeItemNone = -1, 
	UIeducoreNativeItemSpinner = -2,
	UIeducoreNativeItemProgressBar = -3,
	
	UIeducoreNativeItemSlider = -4,
	UIeducoreNativeItemSwitch = -5,
	UIeducoreNativeItemMultiButton = -6,
	UIeducoreNativeItemSegmented = -7,
	
	UIeducoreNativeItemTextView = -8,
	UIeducoreNativeItemTextField = -9,
	UIeducoreNativeItemSearchBar = -10,
	
	UIeducoreNativeItemPicker = -11,
	UIeducoreNativeItemDatePicker = -12,
	
	UIeducoreNativeItemInfoLight = -13,
	UIeducoreNativeItemInfoDark = -14,
	
	UIeducoreNativeItemDisclosure = -15,
	
	UIeducoreNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all educore instances of
